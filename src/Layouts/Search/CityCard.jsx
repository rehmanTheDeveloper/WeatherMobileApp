...
const CityCard = ({details}) => {
  ...
  useEffect(() => {
    currentWeather(details.lon, details.lat, setWeatherState)
    setLoading(false);
  }, [details]);
  ...
  return !Loading ? (
    <Card
      ...
      cardClassName="flex flex-row justify-between" touchable={true} onPress={() => console.log(`City Name: ${details.name} Card Pressed!`)}>
